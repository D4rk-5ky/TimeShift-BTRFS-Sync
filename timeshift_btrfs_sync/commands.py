...
class CommandError(RuntimeError):
    ...
    def __init__(
        ...
        stderr: str = "",
        *,
        stage_returncodes: dict[str, int] | None = None,
        stage_stderr: dict[str, str] | None = None,
    ):
        self.returncode = returncode
        self.stdout = stdout
        self.stderr = stderr
        self.stage_returncodes = dict(stage_returncodes or {})
        self.stage_stderr = dict(stage_stderr or {})
    ...
    *,
    ...
    if left_return != 0 or middle_return != 0 or right_return != 0:
        ...
        raise CommandError(
            ...
            stage_returncodes={
                "send": left_return,
                "buffer": middle_return,
                "receive": right_return,
            },
            stage_stderr={
                "send": "".join(left_err_chunks),
                "buffer": "".join(middle_err_chunks),
