...
class PreflightParserRegressionTests(unittest.TestCase):
...
class StaticRuntimeSymbolAuditTests(unittest.TestCase):
...
class LocalPathSafetyRegressionTests(unittest.TestCase):
...
class SharedTreeSafetyRegressionTests(unittest.TestCase):
    def setUp(self):
